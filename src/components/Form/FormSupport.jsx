  ...
  return (
    <div className='header-form'>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='title-container'>
          <div className='title'>
            ...
            <p>Este formulario busca solucionar tu problema en un plazo de 24 a 48 horas hábiles. Respuesta rápida y eficiente.</p>
          </div>
      ...
      <div className='modal-alert'>
        ...
        <X  className='x' onClick={() => setAlert(false)}>Cerrar</X>
        </div>
